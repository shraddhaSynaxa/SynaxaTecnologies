  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 z-10 bg-white/70 dark:bg-black/70"></div>
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight dark:text-white">
                  Empowering Every Idea, Under One Roof.
                </h1>
                <p className="text-body-color dark:text-body-color-dark mb-12 text-base leading-relaxed! sm:text-lg md:text-xl">
                  We are a parent software company bringing together a suite of
                  innovative products and services under one brand. From
                  business management tools to specialized industry solutions,
                  we create, manage, and scale software that helps companies
